...
const APP_REGISTRY: AppManifest[] = [
  {
    ...
    auth: { type: "forward-auth", client_id: "conversations", issuer: "https://auth.saillant.cc/realms/zacus" },
  ...
  },
  {
    ...
    auth: { type: "forward-auth", client_id: "impress", issuer: "https://auth.saillant.cc/realms/zacus" },
  ...
  },
  {
    ...
    auth: { type: "forward-auth", client_id: "meet", issuer: "https://auth.saillant.cc/realms/zacus" },
  ...
  },
  {
    ...
    auth: { type: "oidc", client_id: "grist", issuer: "https://auth.saillant.cc/realms/zacus" },
  ...
  },
  {
    ...
    auth: { type: "forward-auth", client_id: "dolibarr", issuer: "https://auth.saillant.cc/realms/zacus" },
  ...
  },
  {
    ...
    auth: { type: "oidc", client_id: "synapse", issuer: "https://auth.saillant.cc/realms/zacus" },
