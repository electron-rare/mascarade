...
import { openburoInline } from "./routes/openburo-inline.js";
...
// Open Buro
app.route("/openburo", openburoInline);
app.route("/openburo/objects", openburoObjects);
app.route("/openburo/events", openburoEvents);
...
import { dolibarrSync } from "./routes/dolibarr-sync.js";
import { openburoEvents } from "./routes/openburo-events.js";
import { openburoFiles } from "./routes/openburo-files.js";
...
if (hasFrontend) {
  ...
  app.get("/", (c) => c.json({ name: "mascarade-api", version: "0.3.0" }));
