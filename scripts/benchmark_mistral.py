...
class MistralBenchmark:
    ...
    async def benchmark_latency(
        self, model: str, num_requests: int = 100, concurrent: int = 10
    ) -> Dict:
    ...
    async def benchmark_throughput(self, model: str, duration: int = 60) -> Dict:
    ...
    async def benchmark_embeddings(self, num_requests: int = 100) -> Dict:
    ...
    async def run_benchmarks(self):
        ...
        print(
            f"  Success Throughput: {throughput_results['success_throughput']:.1f} req/s"
        )
        ...
        throughput_score = min(
            100, max(0, throughput_results["throughput"] / 500 * 100)
        )
        ...
        # Overall score
        overall_score = (
            latency_score * 0.4 + throughput_score * 0.4 + reliability_score * 0.2
        )
