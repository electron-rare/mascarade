...
from mascarade.resilience.circuit_breaker import CircuitBreakerManager
...
class Router:
    ...
    def __init__(self) -> None:
        ...
        self.circuit_breakers = CircuitBreakerManager(fail_max=5, timeout_duration=60)
        ...
        *,
        ...
        for attempt_strategy, attempt_provider in sequence:
            ...
            try:
                ...
                # Wrap provider call with Langfuse tracing and circuit breaker
