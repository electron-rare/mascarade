...
class MCPPersistenceManager:
    ...
    async def get_context(self, context_id: str) -> Optional[PersistentModelContext]:
    ...
    async def search_contexts(
        ...
        persist_across_sessions: Optional[bool] = None,
        limit: int = 10
...
async def create_persistent_mcp_context(
    ...
    persistence_flags: Optional[Dict[str, bool]] = None,
    ttl: Optional[int] = None
) -> str:
