...
from mascarade.scheduler.vllm_integration import VLLMWorker, VLLMScheduler
...
def test_paged_attention_eviction():
    ...
    # Fill GPU
    seq1 = manager.allocate_sequence(8)  # 2 blocks
    
    # This should trigger eviction
    seq2 = manager.allocate_sequence(8)  # 2 blocks
